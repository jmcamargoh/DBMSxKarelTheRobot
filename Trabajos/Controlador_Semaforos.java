...
public class Controlador_Semaforos {
    ...
    // intento de semaforo por disponibilidad (problemas de que colisionan en la
    // intersección)
    // // Sector 1
    // public static Semaphore semaforo_trenes_vertical_1 = new Semaphore(1); //
    // Inicialmente permite un tren
    // public static Semaphore semaforo_trenes_horizontal_3 = new Semaphore(1); //
    // Inicialmente permite un tren

    // // Método para verificar si se puede pasar en vertical en el sector 1
    // public static boolean permitirPasarVerticalSector1() {
    // return semaforo_trenes_vertical_1.availablePermits() > 0 ||
    ...
    // return semaforo_trenes_horizontal_3.availablePermits() > 0 ||
    // semaforo_trenes_vertical_1.availablePermits() == 0;
    // }

    // intento de implementar semaforo temporizado
    // private static Lock lockVertical = new ReentrantLock();
    // private static Lock lockHorizontal = new ReentrantLock();
    // private static boolean sentidoVerticalHabilitado = true; // Indica si el
    // sentido vertical está habilitado
    // // actualmente
    ...
    // lockVertical.lock();
    // try {
    // permitido = sentidoVerticalHabilitado &&
    // semaforo_trenes_vertical_1.availablePermits() > 0
    // && semaforo_trenes_horizontal_3.availablePermits() == 0;
    // } finally {
    // lockVertical.unlock();
